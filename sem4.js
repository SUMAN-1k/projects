...

{
    ...
    var n9=parseFloat(document.getElementById("marks9").value);
    var n10=parseFloat(document.getElementById("marks10").value);
...
function marks()
{
    ...
    var n10=parseFloat(document.getElementById("marks5").value)
    var num10;
    if(n10>=90)
    {
        num10=10*2;
